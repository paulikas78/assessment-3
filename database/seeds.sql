...
-- products seeds
INSERT INTO products (id, category_id, prod_name, prod_description, prod_price)
VALUES (1, 1, 'Candlestick', 'silver 8 in. / 20 cm. tall Candlestick', 9.99);

INSERT INTO products (id, category_id, prod_name, prod_description, prod_price)
VALUES (2, 2, 'Plate Set', '4 Large, Ceramic Plates', 14.99);

INSERT INTO products (id, category_id, prod_name, prod_description, prod_price)
VALUES (3, 3, 'Laptop Riser', 'Wooden, 2 in. / 5 cm. Riser For All Laptops', 11.99);

INSERT INTO products (id, category_id, prod_name, prod_description, prod_price)
VALUES (4, 4, 'Shaving Mirror', '8 in. / 20 cm. x 4 in. / 10 cm. Mirror w/ Suction Cups / Shower Wall Mounts', 24.99);

INSERT INTO products (id, category_id, prod_name, prod_description, prod_price)
VALUES (5, 5, 'Welcome Mat', '20 in. / 51 cm. x 50 in. / 115 cm. Black Carpeted Mat', 19.99);
